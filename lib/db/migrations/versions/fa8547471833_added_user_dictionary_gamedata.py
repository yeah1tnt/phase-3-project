"""Added User, Dictionary, GameData

Revision ID: fa8547471833
Revises: b5fbefb2b21c
Create Date: 2023-08-24 18:46:51.525024
...
revision: str = 'fa8547471833'
down_revision: Union[str, None] = 'b5fbefb2b21c'
...
def upgrade() -> None:
    ...
    sa.Column('game_session', sa.String(), nullable=True),
